# csnl-ops — Migration Baseline (Archived 2026-05-12)

> **이 문서는 아카이브입니다.** 2026-05-01 초기 마이그레이션 베이스라인 README의 원본 사본입니다. 본 저장소의 현행 README는 closed-loop researcher uncertainty engine 으로 진화하였습니다.
>
> 본 아카이브는 다음 세 가지 사실의 *역사적 출처*로 보관합니다:
> (a) 도메인 정리 — 연간/주간/비정기 일정 + 파일 네이밍,
> (b) 마이그레이션 prompt 원문,
> (c) `csnl_ops.*` 스키마 시드.
>
> 운영 의사결정에 인용할 때는 현행 [README.md](../../README.md) 및 [docs/HANDOFF.md](../HANDOFF.md) 가 우선합니다.

---

# csnl-ops (2026-05-01 v1)
