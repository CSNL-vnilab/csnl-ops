...
- inbound (researcher → bot): **43**
- outbound (bot → researcher): **51**

## 연구원별

| 이니셜 | 이름 | 확정 | 추정 | 모름 | 받은 | 보낸 | 마지막 응답 (시간) |
|---|---|---:|---:|---:|---:|---:|---:|
| JOP | 박준오 | 21 | 3 | 0 | 13 | 12 | 0.4 |
| BYL | 이보연 | 6 | 4 | 4 | 2 | 7 | 20.6 |
| MSY | 여민수 | 5 | 2 | 4 | 1 | 5 | 95.2 |
| SMJ | 정새미 | 16 | 3 | 2 | 8 | 9 | 0.5 |
| JYK | 김정예 | 3 | 4 | 6 | 1 | 6 | 99.0 |
| BHL | 이보현 | 14 | 2 | 2 | 10 | 7 | 0.4 |
| SYJ | 조수영 | 2 | 3 | 1 | 8 | 5 | 0.2 |
